...
class DefineFineSaftey extends StatefulWidget {
  List<Users> ulist = [];

  DefineFineSaftey(this.ulist);

  @override
  State<DefineFineSaftey> createState() => _DefineFineSafteyState();
}

class _DefineFineSafteyState extends State<DefineFineSaftey> {
  int? _value;
  int k = 0;
            ...
            child: Column(
              children: [
                ...
                FutureBuilder<List<RuleFine>>(
                  future: rf.getSafteyFine(widget.ulist[0].org_id),
