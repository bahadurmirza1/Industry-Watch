...
import 'model/saftey_rule.dart';

class AddSafetyRule extends StatefulWidget {
  const AddSafetyRule({super.key});

  @override
  State<AddSafetyRule> createState() => _AddSafteyRuleState();
}

class _AddSafteyRuleState extends State<AddSafetyRule> {
              ...
              children: [
                ...
                Row(children: [
                  ...
                  CustomButton(() async {
                    ...
                    request.fields['rule_type'] = 0.toString();
