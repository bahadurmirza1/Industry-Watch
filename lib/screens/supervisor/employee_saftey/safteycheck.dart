...
class SafteyData extends StatefulWidget {
  const SafteyData({super.key});

  @override
  State<SafteyData> createState() => _SafteyDataState();
}

class _SafteyDataState extends State<SafteyData> {
  File? img;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: CustomText("Saftey Inspection", Colors.black, 20)),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          CustomText("Ali", Colors.white, 20)
                        ],
                      ),
                      SizedBox(
                        height: 17,
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                              "helmet,Mask", Color.fromARGB(255, 247, 9, 9), 15)
                        ],
                      ),
                    ],
                  ),
